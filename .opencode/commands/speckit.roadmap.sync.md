...
<!-- Extension: roadmap -->
<!-- Config: .specify/extensions/roadmap/ -->
## User Input
...
1. Run `.specify/extensions/roadmap/scripts/powershell/load-config.ps1` from the repo root (the loader substitutes the correct platform-specific
